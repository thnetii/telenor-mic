...
namespace TelenorConnexion.ManagedIoTCloud
{
    public partial class MicManifest
    {
        ...
        public static Task<MicManifest> GetMicManifest(Uri manifestServiceUri, string hostname, HttpClient httpClient, CancellationToken cancellationToken = default)
        {
        ...
        private static async Task<MicManifest> GetMicManifestInternal(Uri manifestServiceUri, string hostname, HttpClient httpClient, CancellationToken cancellationToken = default)
        {
